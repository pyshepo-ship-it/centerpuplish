...
const t = mod.buildSchedulePagesHtml({ mode: "teacher", grades, students, academicYear: "2026-2027", teacherName: "نظام إدارة الدروس الخصوصية", signatureLine: "مع تمنياتي لكم بالتوفيق" })
...
check("توقيع المدرس", t.html.includes("نظام إدارة الدروس الخصوصية"))
