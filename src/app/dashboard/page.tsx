...
export default function DashboardPage() {
  ...
  // اسم الموقع (اسم المدرس/السنتر) من الإعدادات — يتحدّث تلقائياً
  ...
  const quickActions = [
    ...
    {
      label: "دليل التشغيل الكامل",
      description: "شرح طريقة عمل النظام خطوة بخطوة",
      icon: BookOpen,
      ...
      >
        <div className="relative z-10">
          <h1 className="text-3xl md:text-4xl font-bold mb-2">
            أهلاً بك في {siteName || "نظام إدارة الدروس الخصوصية"} 👋
          </h1>
          <p className="text-indigo-100 text-lg">
            نظام متكامل لإدارة السنتر أو الدروس الخصوصية: الطلاب والمجموعات والمواعيد والحضور والتحصيل والاختبارات والتقارير
          </p>
        </div>
      ...
      >
        ...
        <div>
          ...
          <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
            ابدأ بإضافة الصفوف والمجموعات في قسم «الصفوف والمواعيد»، ثم أضِف الطلاب في قسم «الطلاب».
            بعدها استخدم «التحصيل الشهري» لإنشاء الاستحقاقات وتسجيل المدفوعات.
            جميع البيانات تُحفظ تلقائياً على السحابة (Supabase) لتكون متاحة من أي جهاز.
            وللتعرف على كل أقسام النظام بالتفصيل، راجع <a href="/dashboard/guide" className="font-bold text-indigo-600 dark:text-indigo-400 underline">دليل التشغيل الكامل</a>.
          </p>
        </div>
      </motion.div>
    </div>
