...
const menuItems = [
  ...
  { href: "/dashboard/guide", label: "دليل التشغيل الكامل", icon: HelpCircle, color: "from-sky-500 to-cyan-600" },
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-800">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <h1 className="font-bold text-gray-900 dark:text-white truncate" title={siteName}>
                {siteName || "نظام إدارة الدروس الخصوصية"}
              </h1>
              <p className="text-xs text-gray-500 dark:text-gray-400">لوحة إدارة السنتر</p>
            </div>
          </div>
        </div>
