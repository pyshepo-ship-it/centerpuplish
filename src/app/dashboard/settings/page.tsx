...
export default function SettingsPage() {
  ...
  // حفظ هوية الموقع (اسم المدرس / السنتر) — يعيد تسمية الموقع بالكامل
  const saveSiteIdentity = () => {
    const name = teacherNameInput.trim() || DEFAULT_TEACHER_NAME
    setTeacherName(name)
    setTeacherNameInput(name)
    // تحديث فوري لعنوان تبويب المتصفح
    try { document.title = name } catch { /* البيئة غير المتصفح */ }
    toast.success(`تم حفظ الاسم — سيظهر الموقع بالكامل باسم «${name}» للطلاب من أي جهاز`)
  }

  // حفظ سطر التمني فقط في تذييل الاختبارات والشهادات
  ...
  const resetTeacherSignature = () => {
    ...
    toast.success("تمت استعادة الاسم وعبارة التمني الافتراضية")
  }
        ...
        <Card className="bg-white dark:bg-gray-900 border-2 border-indigo-200 dark:border-indigo-900 shadow-xl overflow-hidden">
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-xl">هوية الموقع — اسم المدرس / السنتر</CardTitle>
                <p className="text-sm text-gray-500">
                  اكتب اسم سنترك أو اسمك كمدرس، وسيُعاد تسمية الموقع بالكامل به تلقائياً
                </p>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-5">
            <div className="space-y-2">
              <Label className="font-semibold text-gray-800 dark:text-gray-200 flex items-center gap-2">
                <BadgeCheck className="w-4 h-4 text-indigo-600" />
                اسم المدرس / السنتر
              </Label>
              <Input
                placeholder="مثال: أ/ محمد عبده — أو: سنتر النور للدروس الخصوصية"
                value={teacherNameInput}
                onChange={(e) => setTeacherNameInput(e.target.value)}
                className="mt-1 text-lg font-bold border-indigo-300 dark:border-indigo-700"
              />
              <p className="text-xs text-gray-500 flex items-start gap-1.5">
                <Globe className="w-3.5 h-3.5 mt-0.5 shrink-0" />
                <span>
                  يظهر هذا الاسم في كل مكان: عنوان المتصفح، الصفحة الرئيسية، صفحة الدخول، اللوحة الجانبية،
                  شاشة الترحيب، التذييل، ملفات PDF، أوراق الاختبارات والجداول، ولوحة الشرف —
                  ويُحفظ في السحابة ليظهر للطلاب من أي جهاز.
                </span>
              </p>
            </div>

            {/* معاينة حية لاسم الموقع */}
            <div className="p-4 rounded-xl border border-dashed border-indigo-300 dark:border-indigo-800 bg-indigo-50/50 dark:bg-indigo-950/20">
              <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-2">
                معاينة شكل الاسم في الموقع:
              </p>
              <div className="space-y-2">
                <div className="flex items-center gap-3 bg-white dark:bg-gray-900 rounded-lg px-4 py-3 border border-gray-200 dark:border-gray-700 shadow-xs">
                  ...
                  <span className="font-bold text-gray-900 dark:text-white truncate">
                    {teacherNameInput.trim() || DEFAULT_TEACHER_NAME}
                  </span>
                </div>
                <p className="text-[11px] text-gray-400 px-1" dir="ltr">
                  تبويب المتصفح: {teacherNameInput.trim() || DEFAULT_TEACHER_NAME}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-end gap-3">
              ...
              >
                <RotateCcw className="w-4 h-4" />
                <span>استعادة الاسم الافتراضي</span>
              </Button>
              <Button
        ...
        <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 shadow-lg">
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-xl">عبارة التمني في ذيل الاختبارات والشهادات</CardTitle>
                <p className="text-sm text-gray-500">
                  تخصيص عبارة التمني التي تظهر في نهاية ورقة الامتحان وأسفل لوحة الشرف —
                  أما الاسم فيُضبط من بطاقة «هوية الموقع» بالأعلى
                </p>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500">
                تظهر باللون الداكن فوق اسم الموقع في ذيل ورقة الامتحان.
              </p>
            </div>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  <Input value={userEmail} disabled className="bg-gray-50 dark:bg-gray-800" dir="ltr" />
